...
- **Protocol Modules** – The same `@proto/*` packages used by the CLI, bundled for the browser.
...
- **Custom Validators** – Register additional validators in `@proto/data` and they automatically appear in the playground results.
