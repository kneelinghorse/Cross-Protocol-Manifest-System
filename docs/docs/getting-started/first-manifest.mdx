...
Visit the [live playground](/playground) to paste the manifest and watch Monaco-powered validations in the browser. All logic is reused from `@cpms/data` and runs inside a sandboxed worker.
